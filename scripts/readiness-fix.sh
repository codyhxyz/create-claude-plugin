...
# Companion to readiness.sh. Reads readiness JSON, generates fixes for
# automatable failures. Does not invoke tldr (Category 7 is gone upstream).
#
...
- [ ] No breaking changes' "PR template"
  ...
  # (tldr-powered criteria removed — Category 7 dropped from this port.)
