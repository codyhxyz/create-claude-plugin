...
# Scores a repo across 6 categories / 20 criteria (was 27 upstream; the
# 7 tldr-powered checks from Category 7 were dropped so this script has
# no external binary dependencies beyond python3 + standard Unix tools).
#
...
# (Category 7 — tldr-powered code analysis — removed in this port.)

# ════════════════════════════════════════════════════════════════
# ERROR SURFACE SCORE
# ════════════════════════════════════════════════════════════════

# Max constraints dropped from 11 → 6 with Category 7 removed
# (dead_code, clones, complexity, security_scan, call_graph gone).
